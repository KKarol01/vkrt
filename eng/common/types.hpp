...
using f32_3 = glm::f32vec3;
using f32_4 = glm::f32vec4;
using i32_2 = glm::i32vec2;
using i32_3 = glm::i32vec3;
using i32_4 = glm::i32vec4;
using u32_2 = glm::u32vec2;
using u32_3 = glm::u32vec3;
using u32_4 = glm::u32vec4;
using u64_2 = glm::u64vec2;
using u64_3 = glm::u64vec3;
using u64_4 = glm::u64vec4;
using hash_t = u64;
