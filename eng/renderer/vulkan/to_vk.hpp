...
inline VkFilter to_vk(const ImageFilter& a)
{
    switch(a)
    {
    ...
    default:
    {
        ENG_ASSERT(false, "Unhandled case.");
        return {};
    }
    }
}

inline VkSamplerAddressMode to_vk(const ImageAddressing& a)
{
    switch(a)
    {
    ...
    case ImageAddressing::CLAMP_EDGE:
    {
...
inline VkFormat to_vk(const ImageFormat& a)
{
...
inline VkIndexType to_vk(IndexFormat a)
{
    switch(a)
    {
    case IndexFormat::U8:
...
inline VkFormat to_vk(const VertexFormat& a)
{
    switch(a)
    {
...
inline VkImageType to_vk(const ImageType& a)
{
    switch(a)
    {
...
inline VkImageViewType to_vk(const ImageViewType& a)
{
    switch(a)
    {
...
inline VkImageAspectFlags to_vk(const Flags<ImageAspect>& a)
{
...
inline VkImageLayout to_vk(const ImageLayout& a)
{
    static_assert((int)ImageLayout::LAST_ENUM == 7);
    switch(a)
    {
    case gfx::ImageLayout::UNDEFINED:
    {
        return VK_IMAGE_LAYOUT_UNDEFINED;
    }
    case gfx::ImageLayout::GENERAL:
    {
        return VK_IMAGE_LAYOUT_GENERAL;
    }
    case gfx::ImageLayout::READ_ONLY:
    {
        return VK_IMAGE_LAYOUT_READ_ONLY_OPTIMAL;
    }
    case gfx::ImageLayout::ATTACHMENT:
    {
        return VK_IMAGE_LAYOUT_ATTACHMENT_OPTIMAL;
    }
    case gfx::ImageLayout::TRANSFER_SRC:
    {
        return VK_IMAGE_LAYOUT_TRANSFER_SRC_OPTIMAL;
    }
    case gfx::ImageLayout::TRANSFER_DST:
    {
        return VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL;
    }
    case gfx::ImageLayout::PRESENT:
    {
...
inline VkImageUsageFlags to_vk(const Flags<ImageUsage>& a)
{
...
inline VkCullModeFlags to_vk(const CullFace& a)
{
    switch(a)
    {
    case CullFace::NONE:
...
inline VkCompareOp to_vk(const DepthCompare& a)
{
    switch(a)
    {
...
inline VkShaderStageFlagBits to_vk(const ShaderStage& a)
{
    switch(a)
    {
    case ShaderStage::VERTEX_BIT:
    {
        return VK_SHADER_STAGE_VERTEX_BIT;
    }
    case ShaderStage::PIXEL_BIT:
    {
        return VK_SHADER_STAGE_FRAGMENT_BIT;
    }
    case ShaderStage::COMPUTE_BIT:
    {
        return VK_SHADER_STAGE_COMPUTE_BIT;
    }
    case ShaderStage::RAYGEN_BIT:
    {
        return VK_SHADER_STAGE_RAYGEN_BIT_KHR;
    }
    case ShaderStage::ANY_HIT_BIT:
    {
        return VK_SHADER_STAGE_ANY_HIT_BIT_KHR;
    }
    case ShaderStage::CLOSEST_HIT_BIT:
    {
        return VK_SHADER_STAGE_CLOSEST_HIT_BIT_KHR;
    }
    case ShaderStage::MISS_BIT:
    {
        return VK_SHADER_STAGE_MISS_BIT_KHR;
    }
    case ShaderStage::INTERSECTION_BIT:
    {
...
inline VkSamplerMipmapMode to_vk(const SamplerMipmapMode a)
{
    switch(a)
    {
...
inline VkSamplerReductionMode to_vk(const SamplerReductionMode a)
{
    switch(a)
    {
...
inline VkPrimitiveTopology to_vk(const Topology& a)
{
    switch(a)
    {
...
inline VkPolygonMode to_vk(const PolygonMode& a)
{
    switch(a)
    {
...
inline VkStencilOp to_vk(const StencilOp& a)
{
    switch(a)
    {
    case StencilOp::KEEP:
...
inline VkCompareOp to_vk(const CompareOp& a)
{
    switch(a)
    {
...
inline VkBlendFactor to_vk(const BlendFactor& a)
{
    switch(a)
    {
...
inline VkBlendOp to_vk(const BlendOp& a)
{
    switch(a)
    {
    case BlendOp::ADD:
...
inline VkBufferUsageFlags to_vk(const Flags<BufferUsage>& a)
{
...
inline VkPipelineStageFlags2 to_vk(const Flags<PipelineStage>& a)
{
...
inline VkAccessFlags2 to_vk(const Flags<PipelineAccess>& a)
{
...
inline VkPipelineBindPoint to_vk(const PipelineType& a)
{
    switch(a)
    {
...
inline VkShaderStageFlags to_vk(const Flags<ShaderStage>& a)
{
...
inline VkDescriptorType to_vk(const DescriptorType& a)
{
    switch(a)
    {
...
inline VkDescriptorPoolCreateFlags to_vk(const Flags<DescriptorPoolFlags>& a)
{
    VkDescriptorPoolCreateFlags flags{};
    if(a.test(DescriptorPoolFlags::UPDATE_AFTER_BIND_BIT)) { flags |= VK_DESCRIPTOR_POOL_CREATE_UPDATE_AFTER_BIND_BIT; }
    return flags;
}

inline VkQueryType to_vk(const QueryType& a)
{
    switch(a)
    {
...
inline VkComponentSwizzle to_vk(ChannelSwizzle a)
{
    switch(a)
    {
    case ChannelSwizzle::IDENTITY:
