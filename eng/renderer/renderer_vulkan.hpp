...
class RendererVulkan : public Renderer {
  public:
    ...
    Handle<Buffer> make_buffer(const std::string& name, size_t alignment, const VkBufferCreateInfo& vk_info,
                               const VmaAllocationCreateInfo& vma_info);
    Handle<Buffer> make_buffer(const std::string& name, buffer_resizable_t resizable, size_t alignment,
    ...
    Image& get_view_image(VkImageView view);
    ...
    std::unordered_map<VkImageView, Image*> views;
