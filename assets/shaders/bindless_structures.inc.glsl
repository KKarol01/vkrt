...
#define VSM_VIRTUAL_PAGE_NUM_TEXELS (VSM_PHYSICAL_PAGE_RESOLUTION / VSM_VIRTUAL_PAGE_RESOLUTION)
#define VSM_NUM_CLIPMAPS 8
#define VSM_CLIP0_LENGTH 16.0
#define VSM_MAX_ALLOCS ((VSM_PHYSICAL_PAGE_RESOLUTION / VSM_VIRTUAL_PAGE_NUM_TEXELS) * (VSM_PHYSICAL_PAGE_RESOLUTION / VSM_VIRTUAL_PAGE_NUM_TEXELS))
